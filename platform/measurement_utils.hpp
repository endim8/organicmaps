...
inline double MetersToYards(double m) { return m * 1.093613; }
inline double FeetToYards(double ft) { return ft * 3; }
inline double YardsToMeters(double yd) { return yd * 0.9144; }
inline double YardsToFeet(double yd) { return yd * (1/3); }
